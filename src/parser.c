  ...
  switch (state) {
    ...
    case 3:
      ...
      if (lookahead != 0 &&
          ...
          lookahead != '_' &&
          (lookahead < 'a' || 'z' < lookahead)) ADVANCE(4);
      END_STATE();
    case 4:
      ACCEPT_TOKEN(sym_not_word);
      if (lookahead != 0 &&
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  [0] = {
    ...
    [sym_word] = ACTIONS(1),
    [sym_not_word] = ACTIONS(1),
  },
  [1] = {
    [sym_source_file] = STATE(4),
    [aux_sym_source_file_repeat1] = STATE(2),
    [sym_word] = ACTIONS(3),
    [sym_not_word] = ACTIONS(5),
  },
  [2] = {
    [aux_sym_source_file_repeat1] = STATE(3),
    [ts_builtin_sym_end] = ACTIONS(7),
    [sym_word] = ACTIONS(9),
    [sym_not_word] = ACTIONS(11),
  },
  [3] = {
    [aux_sym_source_file_repeat1] = STATE(3),
    [ts_builtin_sym_end] = ACTIONS(13),
    [sym_word] = ACTIONS(15),
    [sym_not_word] = ACTIONS(18),
  },
};
